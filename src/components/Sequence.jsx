              ...
              <ol>
                <li>
                  ...
                  <ul>
                    ...
                    scenes:
                    <li>
                      Creates a SpringApplication instance - It prepares the
                      Spring Boot application by setting up:
                      <ul>
                        <li>
                          The type of application (e.g. web, reactive, CLI).
                        </li>
                ...
                <li>
                  ...
                  container that holds all your beans (components, services,
                  etc.) <br /> <br />
                </li>
                ...
                <li>
                  ...
                  specific order of locations. From highest to lowest
                  precedence:
                  <ol>
                    {" "}
                    <li>
                      application.properties in /config subdirectory of the
                      current directory.
                    </li>
                    <li>application.properties in the current directory.</li>
                    <li>
                      application.properties in a classpath /config package.
                    </li>
                  ...
                  <ul>
                    <li>
                      Loads the file using PropertiesPropertySourceLoader.
                    </li>
                ...
                <li>
                  ClassPath scanning finds your @Component, @Service,
                  @Controller, etc.
                </li>
                <li>
                  Auto-configuration kicks in (magic via
                  @EnableAutoConfiguration). <br />
                  Thanks to @EnableAutoConfiguration, Spring Boot uses
                  spring.factories to load many pre-built configurations based
                  on what’s on the classpath (e.g. DataSource, WebMvc,
                  Security). <br /> <br />
                </li>
                <li>
                ...
                <li>
                  An embedded server (like Tomcat/Jetty/Undertow) is started if
                  it’s a web app.
                </li>
                <li>
                  ApplicationRunner / CommandLineRunner beans are executed.
                </li>
              </ol>
            </Col>
            <Col xs="8" md="3">
